...
class AppThemeData extends AppThemeExtension {
  ...
  final Color warning;
  final Color successOrder;
  final Color failedOrder;
  final Color warningOrder;
  ...
  AppThemeExtension lerp(AppThemeExtension? other, double t) {
    ...
    return AppThemeData(
      ...
      warningOrder: lerpColor(warningOrder, other.warningOrder),
      successOrder: lerpColor(successOrder, other.successOrder),
      failedOrder: lerpColor(failedOrder, other.failedOrder),
    );
  }
